...
export default function PaymentMethod({onPressToSubmit}:any) {
const {onCreateCustomer,checkoutData}=useCheckoutContext();
...
console.log("paymentdata",checkoutData);
  ...
  const paymentoptions=(()=>{
    RNUpiPayment.initializePayment({
      vpa: 'madhuribkhatal@okicici', // or can be john@ybl or mobileNo@upi
      payeeName: 'John Doe',
      amount: '1',
  ...
  return (
    <View>
      ...
      <Button mode='contained-tonal' onPress={paymentoptions}> Pay Now </Button>
    </View>
  )
}